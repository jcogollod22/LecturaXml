 ...
 * @author Jose Cogollo
 */
public class InformacionDetalladaTrimestre2 implements Serializable{
    ...
    public InformacionDetalladaTrimestre2() {
    }

    public InformacionDetalladaTrimestre2(String sector, String nombreEntidad, String tipoEntidad, String nombreEntidadOrigenCartera, String tipoFid, String numeroFideico, String modalidadCredito, String calificacion, String tipoMoneda, int numeroDeudas, double valorDeudas, double pade, double porcentajeGarantia, String tipoGarantia, String fechaAvaluo, double cuotaEsparada, double porcentajeCumplimiento) {
        this.sector = sector;
