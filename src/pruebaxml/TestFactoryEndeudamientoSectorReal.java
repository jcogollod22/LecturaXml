 ...
 * @author Jose Cogollo
 */
public class TestFactoryEndeudamientoSectorReal {
    
     public static List<EndeudamientoSectReal> modreport2  = null;
	...
	public void setModeloReport1(List<EndeudamientoSectReal> modreport2){
